...
const CATEGORIES = [
    { id: 'AB', name: 'A & B: Story, Language & Culture', type: 'Creative', tasks: [
    ...
    { id: 'CD', name: 'C & D: Infrastructure & Personnel', type: 'Technical', tasks: [
...
const PRESETS: Record<string, PresetData> = {
    "Barbie (2023)": {
        budget: 145, ukSpend: 80, boxOffice: 1441,
        ...
        backdrop: "https://image.tmdb.org/t/p/original/iGdHtZBjpBkmSAgkvUeniIfI8ME.jpg",
    ...
    "Gravity (2013)": {
        budget: 100, ukSpend: 80, boxOffice: 723,
        bypassesGoldenRule: true,
        letterboxd: "https://letterboxd.com/film/gravity-2013/",
        poster: "https://image.tmdb.org/t/p/original/kZ2nZw8D681aphje8NJi8EfbL1U.jpg",
        backdrop: "https://image.tmdb.org/t/p/original/jP4Z9Jy1NhfpDRjoFNmvlvSlzMd.jpg",
    ...
    "Avengers: Age of Ultron (2015)": {
        budget: 365, ukSpend: 85, boxOffice: 1402,
        bypassesGoldenRule: true,
        ...
        backdrop: "https://image.tmdb.org/t/p/original/eFmyHmeZX433dXtXFHeYdIOcEwz.jpg",
    ...
    "Aftersun (2022)": {
        budget: 2.5, ukSpend: 35, boxOffice: 3.4,
        bypassesGoldenRule: false,
        letterboxd: "https://letterboxd.com/film/aftersun/",
        poster: "https://image.tmdb.org/t/p/original/hstKwXZb2h6m9HW3U6lzD5seja7.jpg",
        backdrop: "https://image.tmdb.org/t/p/original/kUxV378ryuayTOrXzGAqVcty2DG.jpg",
...
export default function BFILoopholeCalculator() {
    ...
    const goldenPointsViolation = !bypassesGoldenRule && a1 < 2 && a2 < 2 && a3 < 4;

    const qualifies = total >= PASS_MARK && ukSpendPercent >= 10 && !goldenPointsViolation;

    const rebate = qualifies
        ? (Math.min(budget * ukSpendPercent / 100, budget * 0.8) * 0.255).toFixed(1)
        : null;
        ...
        <div className="max-w-3xl mx-auto rounded-2xl shadow-xl font-sans my-10 border border-border bg-card text-foreground overflow-visible">
            ...
            {isPreset && presetData && (
                <div className="relative overflow-visible rounded-t-2xl">
                    ...
                    <div className="relative z-10 flex gap-2 px-6 md:px-8 pb-5 flex-wrap" role="group" aria-label="Select a film">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        <div>
                            ...
                            <input
                                ...
                                onBlur={(e) => sendGAEvent('event', 'bfi_custom_inputs_changed', {
                                    field:           'budget',
                        ...
                        <div>
                            ...
                            <input
                                id="bfi-ukspend"
                                type="number" min={0} max={100} value={ukSpendPercent}
