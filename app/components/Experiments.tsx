    ...
    <section className="py-12 border-t border-zinc-200 dark:border-zinc-800">
      ...
      <div className="grid grid-cols-1 gap-6">
        <a
          ...
          className="group block rounded-xl border border-zinc-200 bg-zinc-50/50 p-8 transition-all hover:border-zinc-300 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/50 dark:hover:border-zinc-700 dark:hover:bg-zinc-900"
        >
          <div className="mb-2 text-xs font-medium tracking-wide text-zinc-600 uppercase dark:text-zinc-400">
            Project 01 • In development
          </div>
          <h2 className="font-serif text-2xl text-zinc-900 dark:text-zinc-100 mb-4">
            related.pictures
          </h2>
          ...
          <span className="inline-flex items-center text-sm font-semibold text-zinc-900 dark:text-zinc-100">
            Launch Tool
            <svg
              viewBox="0 0 16 16"
              fill="none"
