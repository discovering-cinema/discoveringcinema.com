...
softwareApplication:
  name: 'BFI Cultural Test & Loophole Calculator'
  operatingSystem: 'Any'
  applicationCategory: 'EducationalApplication, FinanceApplication'
  description: "An interactive tool to calculate if a film qualifies for UK tax relief. Includes presets for 'Gravity', 'Barbie', and 'Avengers: Age of Ultron' to demonstrate how high-budget productions meet British certification requirements."
  offers:
    price: '0'
    priceCurrency: 'GBP'
  featureList:
    - 'Points breakdown for BFI Cultural Test sections A through D'
    - 'AVEC rebate estimation based on budget and UK spend'
    - 'Golden Points Rule validation'
    - 'Historical film presets for comparative analysis'
---
